...
export default {
  ...
  mounted: function () {
    if (this.$store.state.onboarding == false) {
      this.$fire({
        title: "關於金鸞+",
        html: "金鸞+是服務金鑾居民的優質影音串流平台，內容包含各類居民自製節目，提供您多樣的收視選擇，大幅提升您的觀影體驗。<br/><br/>使用之前，有一件事情請您再三牢記，任何找不到的節目，或是您認為重要的關鍵字，都可透過上方搜索鍵來一探究竟。<br/><br/>找到那三把記憶的鑰匙，您就會看到金鸞+悉心為您準備的獨家驚喜。",
        type: "info",
      }).then((r) => {
        // * 選擇同意
